...
# --------------------------------
if task == "Home":
    st.markdown("## Welcome to the Knee Classification App")
    st.markdown("""
    ...
    """)
    st.image("man-knee-pain-he-puts-260nw-2476578973.jpg.webp", caption="Knee Classification", use_column_width=True)
